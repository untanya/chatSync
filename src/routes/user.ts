...
router.put("/users/:id", async (req, res) => updateEntity(req, res, (await initORM()).userRepo, "Utilisateur"));
router.patch("/users/:id", async (req, res) => patchEntity(req, res, (await initORM()).userRepo, "Utilisateur"));
